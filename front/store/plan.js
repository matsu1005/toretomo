...
export const actions = {
  ...
  async createPlan({ commit }, plan) {
    ...
    await this.$axios
      ...
      .then((response) => {
        ...
        this.$axios.get("api/v1/plans").then((response) => {
  ...
  async updatePlan({ commit }, plan) {
    await this.$axios
      ...
      .then((response) => {
        commit("openPlanDialog", false)
        commit("flashMessage/setMessage", "投稿を編集しました。", {
          root: true,
        })
        commit("flashMessage/setType", "success", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
        ...
        commit("errorMessage/clearMessages", null, { root: true })
        commit("setSuccessPost", true)
        this.$axios.get(`api/v1/users/${plan.user_id}`).then((response) => {
          commit("user/setUser", response.data, { root: true })
        })
      })
      .catch((error) => {
        commit("flashMessage/setMessage", "投稿の編集が失敗しました。", {
          root: true,
        })
        commit("flashMessage/setType", "error", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
  ...
  async deletePlan({ commit }, plan) {
    await this.$axios
      ...
      .then((response) => {
        commit("flashMessage/setMessage", "投稿したプランを削除しました。", {
          root: true,
        })
        commit("flashMessage/setType", "success", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
      ...
      .catch((error) => {
        commit("flashMessage/setMessage", "プランの削除に失敗しました。", {
          root: true,
        })
        commit("flashMessage/setType", "error", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
  ...
  async joinPlan({ commit }, formData) {
    await this.$axios
      ...
      .then((response) => {
        commit("flashMessage/setMessage", "練習プランに参加しました。", {
          root: true,
        })
        commit("flashMessage/setType", "success", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
        ...
        this.$axios.get(`api/v1/plans/${formData.plan_id}`).then((response) => {
          commit("setPlan", response.data)
        })
        this.$axios.get("api/v1/plans").then((response) => {
          commit("setPlans", response.data)
        })
        this.$axios.get(`api/v1/users/${formData.user_id}`).then((response) => {
          commit("user/setUser", response.data, { root: true })
        })
      })
      .catch((error) => {
  ...
  async unJoinPlan({ commit }, formData) {
    await this.$axios
      ...
      .then((response) => {
        commit("flashMessage/setMessage", "練習プランの参加を解除しました。", {
          root: true,
        })
        commit("flashMessage/setType", "success", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
  ...
  async haveInterest({ commit }, formData) {
    await this.$axios
      ...
      .then((response) => {
        commit("flashMessage/setMessage", "「気になる」に追加しました。", {
          root: true,
        })
        commit("flashMessage/setType", "success", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
      ...
      .catch((error) => {
        commit("flashMessage/setMessage", "処理が失敗しました。", {
          root: true,
        })
        commit("flashMessage/setType", "error", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
  ...
  async notInterest({ commit }, formData) {
    await this.$axios
      ...
      .then((response) => {
        commit("flashMessage/setMessage", "「気になる」から外ししました。", {
          root: true,
        })
        commit("flashMessage/setType", "success", { root: true })
        commit("flashMessage/setStatus", true, { root: true })
